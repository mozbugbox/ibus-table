    ...
    GObjectConstructParam *construct_properties)
{
  ...
  tabsqlitedb_getime(IBUS_TABLE_ENGINE(obj)->db, "valid_input_chars",
      &valid_input_chars);
  IBUS_TABLE_ENGINE(obj)->editor = editor_new(NULL, valid_input_chars, 16,
      IBUS_TABLE_ENGINE(obj)->db);
